...
!function( $ ) {
	...
	var DPGlobal = {
		...
		dates:{
			days: ["Sekamdienis", "Pirmadienis", "Antradienis", "Trečiadienis", "Ketvirtadienis", "Penktadienis", "Šeštadienis", "Sekamdienis"],
			daysShort: ["Sek", "Pir", "Ant", "Tre", "Ket", "Pen", "Šeš", "Sek"],
			daysMin: ["Se", "Pi", "An", "Tr", "Kt", "Pe", "Še", "Se"],
			months: ["Sausis", "Vasaris", "Kovas", "Balandis", "Gegužė", "Birželis", "Liepa", "Rugpjūtis", "Rugsėjas", "Spalis", "Lapkritis", "Gruodis"],
